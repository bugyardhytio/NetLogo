...
public strictfp class VTextIcon implements Icon, PropertyChangeListener {
  ...
  void calcDimensions() {
    ...
    if (fRotation == ROTATE_NONE) {
      ...
      for (int i = 0; i < len; i++) {
        ...
        if (S_DRAWS_IN_TOP_RIGHT.indexOf(ch) >= 0) // if ch is in sDrawsInTopRight
          fPosition[i] = POSITION_TOP_RIGHT;
        else if (S_DRAWS_IN_FAR_TOP_RIGHT.indexOf(ch) >= 0)
   ...
   * <p/>
   * from the online edition of _The Unicode Standard, Version 3.0_, file c
   * h10.pdf page 4
  ...
  static final String S_DRAWS_IN_TOP_RIGHT =
      "\u3041\u3043\u3045\u3047\u3049\u3063\u3083\u3085\u3087\u308E" + // hiragana
          "\u30A1\u30A3\u30A5\u30A7\u30A9\u30C3\u30E3\u30E5\u30E7\u30EE\u30F5\u30F6"; // katakana
  static final String S_DRAWS_IN_FAR_TOP_RIGHT = "\u3001\u3002"; // comma, full stop
  ...
  static final double NINETY_DEGREES = StrictMath.toRadians(90.0);
